...
class CalcRec {
  ...
  @HiveField(11)
  double rating; // цена в местной валюте
  ...
  @HiveField(10)
  String? place; // долгота  геопозиция места сохранения
  ...
  CalcRec(
      this.date, this.title, this.price, this.rating, this.comment, this.weight,
      {this.codeName,
      this.barcode,
      this.latitude,
      this.longitude,
